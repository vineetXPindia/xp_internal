        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              searchableDropdown(screenHeight, screenWidth, 'Select Origin',
                  Icons.map_outlined),
              searchableDropdown(screenHeight, screenWidth,
                  'Select Destination', Icons.location_on),
              searchableDropdown(screenHeight, screenWidth,
                  'Select Service Type', Icons.card_travel_rounded),
              searchableDropdown(screenHeight, screenWidth,
                  'Select Vehicle Type', Icons.local_shipping_outlined),
              SizedBox(
                height: screenHeight * 0.01,
              ),
              Container(
